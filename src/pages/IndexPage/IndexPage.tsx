...
import { Section, List, Placeholder } from "@telegram-apps/telegram-ui";
...
export const IndexPage: FC = () => {
  ...
  const userName = initData?.user?.firstName || "User";

  return (
    <List>
      <Section header="BrewVibe" footer={`Mellow, ${userName}!`}></Section>
